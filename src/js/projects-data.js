...
async function getSpecificRepositories() {
    try {
        ...
        const specificRepositories = ["alaclimabom","links.jonathafernandes","habithub","form-ex-alunos","insight-cast","git-search","notesnest","cv-express","organo"];
        ...
        listItem.innerHTML = `
            ...
            <div class="repo-image">
                <img src="./public/images/projects/${repo.name}.png" alt="">
            </div>
            <div class="buttons">
